...
export default async function handler(req, res) {
  ...
  try {
    ...
    const prompt = `You are professional interior designer. You might be given an empty room or already designed. Add a few but not  lot of furnitures to enhance the interior design. Your task is to transform this room into ${interiorStyle.toLowerCase()} interior design style. Keep the exact same room layout, dimensions, windows, doors, and architectural features. Only change furniture, colors, textures, wall treatments, lighting fixtures, and decorative elements to match ${interiorStyle} style. Maintain the same perspective, room structure, and spatial relationships. High quality, professional interior design, realistic lighting, detailed textures, photorealistic.Dont make it too ai , make it simple and the most important thing - the lauot of the room shoud be the same ,also the size and the part of the room. Never add aditional rooms or doors or whatever. Keep it simple dont over interior-design it`;
